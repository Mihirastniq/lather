...
class User(models.Model):
    ...
    user_image = models.ImageField(upload_to="media/myImages/",null=True,blank=True)
    is_admin = models.IntegerField()
    forgot_password_token = models.CharField(max_length=100,default="")
    pincode = models.ForeignKey(Area,null=True,on_delete=models.SET_NULL, db_column='area_pincode',default="362205")
...
class Item(models.Model):
    ...
    item_category_iditem_category = models.ForeignKey(Subcategory, on_delete=models.SET_NULL, null=True, db_column='subcategory_idsubcategory')
